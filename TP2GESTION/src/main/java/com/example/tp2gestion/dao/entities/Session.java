...
public class Session {
    ...
    public void setStudentsList(List<Student>s){
        this.studentsList = s;
    }
    ...
    public Session(Integer id, String date, String startTime, String endTime, Course sessionCourse, List<Student> studentsList ) throws ParseException{
